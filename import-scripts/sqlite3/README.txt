...
Synopsis
=================================================================
schema.sql and import.sql will help you import files generated by
...
schema.sql
=================================================================
schema.sql creates 4 tables, one for each file generated by the
DWC-A exporter:
...
Note that schema.sql will not create the database itself. You
...
* If the database does not yet contain the tables, run
  schema.sql; otherwise you can skip this step. Run schema.sql by
  clicking on the schema.sql tab and press Execute
